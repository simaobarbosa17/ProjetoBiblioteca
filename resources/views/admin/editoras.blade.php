        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-x-auto">
                ...
                <div class="mb-4 text-right">
                    <a href="{{ route('admin.editoras.create') }}" class="btn btn-success">
                        ➕ Inserir Editora
                    </a>
                </div>
                <div class="overflow-x-auto">
                        ...
                        <tbody>
                            @foreach ($editora as $editoras)
                                <tr class="hover:bg-base-200/50 border-b border-base-200">
                                    ...
                                    <td class="py-3 px-3">
                                        <div class="flex flex-col items-center gap-2">
                                            <img src="{{ Storage::url(str_replace('storage/app/public/', '', $editoras->logótipo)) }}"
                                                alt="Logotipo da Editora" width="130" height="170"
                                    ...
                                    <td class="py-3 px-3 text-center">
                                        <form action="{{ route('admin.editoras.destroy', $editoras->id) }}" method="POST"
