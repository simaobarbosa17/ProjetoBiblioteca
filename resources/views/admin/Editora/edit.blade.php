        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.editoras.update', $editora->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-control mt-4">
                                <label class="label">
                                    <span class="label-text font-medium">Novo Logótipo (opcional)</span>
                                </label>
                                <div class="flex items-center space-x-4">
                                    @if ($editora->logótipo)
                                        <div class="avatar">
                                            <div class="w-24 h-32 rounded">
                                                <img src="{{ Storage::url(str_replace('storage/app/public/', '', $editora->logótipo)) }}"
                                                    alt="Logo atual" />
                                            </div>
                                        </div>
                                    @endif
