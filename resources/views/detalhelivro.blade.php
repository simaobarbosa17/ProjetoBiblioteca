    ...
    <div class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="shadow-lg rounded-lg p-6 mb-8">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-xl font-bold">Reviews dos Leitores</h3>
                <span class="text-sm">{{ $livro->reviews->count() }} review(s)</span>
            </div>
            ...
            @if($livro->reviews->isEmpty())
                <div class="text-center py-8">
                    ...
                    <h3 class="mt-2 text-sm font-medium">Nenhum review ainda</h3>
                </div>
            @else
                <div class="space-y-6">
                        ...
                        <div class="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-r-lg">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-2 leading-relaxed">{{ $review->descricao }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
