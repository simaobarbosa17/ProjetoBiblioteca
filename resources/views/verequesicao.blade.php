<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-base-content text-center">Minhas Requisições</h2>
    </x-slot>
    ...
    <div class="container mx-auto px-4 py-8 space-y-8">
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <h3 class="card-title text-success text-xl mb-6 flex justify-center items-center gap-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center items-center">
                    @forelse($ativas as $requisicao)
                        <div class="card bg-base-200 shadow-md hover:shadow-lg transition-shadow duration-200 flex flex-col justify-center items-center text-center">
                            <div class="card-body flex flex-col justify-center items-center">
                                <h4 class="card-title text-lg mb-3">{{ $requisicao->livro->nome }}</h4>

                                <div class="flex items-center gap-2 text-sm text-base-content mb-4 justify-center">
                                ...
                                <div class="card-actions justify-center">
                                    <form action="{{ route('requisicoes.devolver', $requisicao->id) }}" method="POST" class="flex justify-center">
                                        @csrf
                                        @method('PATCH')
                                        <button 
                                            type="submit" 
                    ...
                    @empty
                        <div class="alert col-span-full flex justify-center items-center text-center">
                            <svg class="h-6 w-6 stroke-current mr-2" fill="none" viewBox="0 0 24 24">
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <h3 class="card-title text-error text-xl mb-6 flex justify-center items-center gap-2">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="card bg-base-200 shadow-md hover:shadow-lg transition-shadow duration-200 flex flex-col justify-center items-center text-center">
                            <div class="card-body flex flex-col justify-center items-center">
                                ...
                                @if ($requisicao->review === null)
                                    <div class="bg-base-100 border border-base-300 rounded-lg p-4 mt-4 w-full max-w-md mx-auto">
                                ...
                                @else
                                    <div class="alert alert-success mt-4 p-3 flex justify-center items-center text-center">
